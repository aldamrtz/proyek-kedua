...
docker tag aldaaa/karsajobs-ui:latest ghcr.io/aldamrtz/a433-microservices/karsajobs-ui:latest
...
docker push ghcr.io/aldamrtz/a433-microservices/karsajobs-ui:latest